...
//nested function of generate invoice
	...
	var disclaimerOrder = document.createElement("div");
	disclaimerOrder.setAttribute("id", "disclaimer");
	...
	newOrder.appendChild(disclaimerOrder);
	...
	const disclaimer = "<h6>Attention: When you provide a check as a payment, you authorize us either to use information from your check to make a one-time electronic funds transfer from your checking account or to process the payment as a check transaction. For inquiries, please call: (210)488-5030.</h6>"
	...
	disclaimerOrder.innerHTML = disclaimer;
